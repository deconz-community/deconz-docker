...
| `-e DECONZ_WEBS_PORT=0`                              | By default, the web HTTPS UIs ("Wireless Licht Control" and "Phoscon") is disabled; only set this environment variable if you wish to change and activate the listen port.                                                                                                                              |
